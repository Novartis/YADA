...
public class FinderTest {
  ...
  /**
   * Tests {@link JdbcFinder#getQuery(String)}.  The test is successful if the query {@code YADA test SELECT} is retrieved without error.
  ...
  {
  	new JdbcFinder().getQuery("YADA test SELECT");
  }
  
  
  /**
   * Tests {@link JdbcFinder#getQuery(String)} with a non-existent query.  
  ...
  {
  	new JdbcFinder().getQuery("YADA fake query");
  }
