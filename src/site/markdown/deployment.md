...
* Click any of the [YADA-Quickstart] links throughout this document to download the `YADA-Quickstart-6.2.2.war` file, or
...
After making your desired changes, simply run `mvn package` in the `YADA-Quickstart` directory.  This will result in a `YADA-Quickstart-6.2.2.war` file in the `target` subdirectory.  This warfile can now be copied to your tomcat container.
...
cp ~/YADA-Quickstart-6.2.2/src/main/resources/dev/yada.httpd.conf .
...
[YADA]: URL
[YADA-Quickstart]: ../resources/downloads/YADA-Quickstart-6.2.2.war
[warfile]: ../resources/downloads/YADA-Quickstart-6.2.2.zip
