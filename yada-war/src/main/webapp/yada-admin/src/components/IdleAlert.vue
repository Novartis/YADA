  ...
  <div>
    <div v-if="!!idle">
      <div class="ui basic modal">
        ...
        <div class="actions">
          <div v-if="!!auth" class="ui red basic cancel inverted button" @click="resetTimer">
            <i class="remove icon"></i>
            Stay logged in
          </div>
          <div class="ui green ok inverted button" @click="logout">
...
export default {
  ...
  methods: {
    ...
    authenticationTime() {
      // console.log('authTime',this.idle,this.auth);
      let rx_cookie = /qdsschkr/
      let rx_domain = /local/
