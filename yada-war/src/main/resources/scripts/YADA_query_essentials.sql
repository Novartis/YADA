...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA select default params for app','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA insert default param','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=qname:getValue(TARGET) uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA update default param','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=qname:getValue(TARGET) uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA delete default param','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA select props for target','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=app:getValue(TARGET) uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA select props for targets','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA select props like target','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=app:getValue(TARGET) uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA insert prop','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA update prop','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA delete prop','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA delete prop for target','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=uid:getLoggedUser()');
...
INSERT into YADA_QUERY (qname,query,created_by,app) VALUES ('YADA new app admin','insert into yada_ug (app,uid,role) values (?v,?v,''ADMIN'')', 'YADABOT', 'YADA');
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA new app admin','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA update app','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA queries','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA new query','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA insert usage log','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA update query','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA delete query','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=uid:getLoggedUser()');
...
INSERT into YADA_PARAM (id,target,name,rule,value) VALUES ('1','YADA select protectors for target','pl',1,'Gatekeeper,content.policy=void,execution.policy.columns=qname:getValue(TARGET) uid:getLoggedUser()');
...
-- protector queries
INSERT into YADA_QUERY (qname,query,created_by,app) VALUES ('YADA new app protector','select 1 from yada_ug where upper(role)=''ADMIN'' and uid=?v','YADABOT','YADA');
INSERT into YADA_QUERY (qname,query,created_by,app) VALUES ('YADA crud protector','select 1 from yada_ug where upper(role)=''ADMIN'' and app=?v and uid=?v','YADABOT','YADA');
INSERT into YADA_QUERY (qname,query,created_by,app) VALUES ('YADA crud by qname protector','select 1 from yada_ug where upper(role) = ''ADMIN'' and app = (select app from yada_query where qname = ?v) and uid=?v','YADABOT','YADA');
INSERT into YADA_QUERY (qname,query,created_by,app) VALUES ('YADA view protector','select 1 from yada_ug where upper(role) in (''ADMIN'',''USER'') and app=?v and uid=?v','YADABOT','YADA');
...
INSERT INTO YADA_USER (UID,PW) VALUES ('YADA','yada');
INSERT INTO YADA_USER (UID,PW) VALUES ('YADAUSER','yada');
INSERT INTO YADA_USER (UID,PW) VALUES ('test','testt');
